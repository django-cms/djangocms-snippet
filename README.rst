...
Migration 0010 requires the use of a user in order to create versions for existing snippets, a user can be
chosen with the setting ``DJANGOCMS_SNIPPET_VERSIONING_MIGRATION_USER_ID``

    DJANGOCMS_SNIPPET_VERSIONING_MIGRATION_USER_ID = 1 # Will use user with id: 1
